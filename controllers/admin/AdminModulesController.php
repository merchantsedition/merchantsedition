...
class AdminModulesControllerCore extends AdminController
{
    ...
    public function renderKpis()
    {
        ...
        /**
         * Show how many modules can be updated (patch, minor or major). Value
         * should be calculated via the _PS_CACHE_DIR_/modules.json cache file
         * that is generated by class ModuleUpdate.
         */
        $helper = new HelperKpi();
